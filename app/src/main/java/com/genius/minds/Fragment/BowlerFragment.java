...
public class BowlerFragment extends BaseFragment {
    RecyclerView rec_bowlers;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rec_bowlers=view.findViewById(R.id.rec_bowlers);
        RecyclerView.LayoutManager vertical = new LinearLayoutManager(context, LinearLayoutManager.VERTICAL,false);
        rec_bowlers.setLayoutManager(vertical);
        rec_bowlers.setItemAnimator(new DefaultItemAnimator());
        ...
        rec_bowlers.setAdapter(adapterWicketKeeper);
