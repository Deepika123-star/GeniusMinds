...
public class WicketKeeperFragment extends BaseFragment {
RecyclerView rec_wicketKeeper;
...
ArrayList<ModelWicketKeeper>modelWicketKeepers;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_weaket_keeper, container, false);
        rec_wicketKeeper=view.findViewById(R.id.rec_wicketKeeper);

        RecyclerView.LayoutManager vertical = new LinearLayoutManager(context, LinearLayoutManager.VERTICAL,false);
        rec_wicketKeeper.setLayoutManager(vertical);
        rec_wicketKeeper.setItemAnimator(new DefaultItemAnimator());
        ...
        rec_wicketKeeper.setAdapter(adapterWicketKeeper);
