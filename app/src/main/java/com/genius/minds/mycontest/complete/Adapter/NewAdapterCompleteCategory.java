...
import com.genius.minds.mycontest.complete.CompleteContest;
import com.genius.minds.mycontest.live.LiveContest;
import com.genius.minds.mycontest.upcoming.UpcomingMatchContest;

import java.util.List;

public class NewAdapterCompleteCategory extends RecyclerView.Adapter<NewAdapterCompleteCategory.AdapterViewHolder> {
   List<com.genius.minds.Model.ResponseCompleteSubCategorys.SubcategoryListItem> model_banners;
   Context context;

   public NewAdapterCompleteCategory(List<SubcategoryListItem> model_banners, Context context) {
   ...
   public void onBindViewHolder(@NonNull AdapterViewHolder holder, @SuppressLint("RecyclerView") int position) {
      ...
      holder.rel.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View v) {
            Intent intent = new Intent(context, CompleteContest.class);
