...
public class AdapterHomeUpcoming extends RecyclerView.Adapter<AdapterHomeUpcoming.AdapterViewHolder> {
    List<CategoryListItem> model_banners;
    Context context;

    public AdapterHomeUpcoming(List<CategoryListItem> model_banners, Context context) {
...
//                Intent intent=new Intent(context, UpcomingMatches.class);
