...
public class CompleteContestAdapter extends RecyclerView.Adapter<CompleteContestAdapter.ProductViewHolder>{

    private Context mCtx;
    private List<CompleteContestModel> productList;
    public CompleteContestAdapter(Context mCtx, List<CompleteContestModel> productList) {
        this.mCtx = mCtx;
    ...
    @Override
    public CompleteContestAdapter.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.card_contest_upcoming, null);
        return new CompleteContestAdapter.ProductViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CompleteContestAdapter.ProductViewHolder holder, @SuppressLint("RecyclerView") int position) {
        final CompleteContestModel product = productList.get(position);
        ...
        String time=product.getStarttime();
        ...
        holder.ledgerboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("contestid_UserEmail",""+product.getUseremail());
        ...
        holder.btn_prizeBreakUp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("contestid",""+productList.get(position).getContestid());
                mCtx.startActivity(intent);
            }
        });
