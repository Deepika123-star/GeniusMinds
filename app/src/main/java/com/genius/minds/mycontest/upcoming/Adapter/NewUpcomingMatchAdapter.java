...
public class NewUpcomingMatchAdapter extends RecyclerView.Adapter<NewUpcomingMatchAdapter.AdapterViewHolder> {
   List<MatchListItem> model_banners;
   Context context;

   public NewUpcomingMatchAdapter(List<MatchListItem> model_banners, Context context) {
...
//      holder.tv_seriesNamesTime.setText(model_banners.get(position).getMtime());
      ...
      holder.cv_first.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
            Intent intent=new Intent(context, UpcommingAllCatgoryActivity.class);
   ...
   public class AdapterViewHolder extends RecyclerView.ViewHolder{
      ...
      CardView cv_first;
      TextView tv_seriesName,tv_teamOne,tv_teamTwo,timeleft;
