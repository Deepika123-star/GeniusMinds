...
public class UpcomingMatchModel {
    ...
    public UpcomingMatchModel(int id, String category, String series,String matchcode ,String team1, String team2, String f_logo, String s_logo, String mdate, String mtime) {
        this.id = id;
