...
public class CompleteMatchAdapter extends RecyclerView.Adapter<CompleteMatchAdapter.ProductViewHolder>{


    private Context mCtx;
    private List<CompleteMatchModel> productList;

//    String path="https://geniusbetting.in/admin/upload/";
    String path="https://pragatisoulutions.com/geniusbetting/admin/upload/";


    public CompleteMatchAdapter(Context mCtx, List<CompleteMatchModel> productList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(final ProductViewHolder holder, int position) {
        final CompleteMatchModel product = productList.get(position);
...
//        logoTwo=getIntent().getStringExtra("logo2");
                ...
                Intent intent = new Intent(mCtx, CompleteSubCategory.class);
