...
import com.genius.minds.Activity.UpcommingAllCatgoryActivity;
...
public class UpcomingMatchAdapter extends RecyclerView.Adapter<UpcomingMatchAdapter.ProductViewHolder>{


    private Context mCtx;
    private List<UpcomingMatchModel> productList;
...
//    String path="https://pragatisoulutions.com/geniusbetting/geniusapi/upload/";
    ...
    public UpcomingMatchAdapter(Context mCtx, List<UpcomingMatchModel> productList) {
        this.mCtx = mCtx;
    ...
    @Override
    public void onBindViewHolder(final ProductViewHolder holder, @SuppressLint("RecyclerView") int position) {
        final UpcomingMatchModel product = productList.get(position);
...
//                mCtx.startActivity(intent);
                Intent intent=new Intent(mCtx, UpcomingSubCategory.class);
                ...
                intent.putExtra("logo11",path+productList.get(position).getF_logo());
                intent.putExtra("logo12",path+productList.get(position).getS_logo());
                mCtx.startActivity(intent);
