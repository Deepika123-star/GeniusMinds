...
public class CompleteMatches extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener  {

    private ProgressBar spinner;
    private static final String TAG = "Genius";
    List<CompleteMatchModel> productList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_matches);
...
//        Toast.makeText(this, ""+category, Toast.LENGTH_SHORT).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, COMPLETE_MATCH_LIST+category+"&email="+emailuser,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new CompleteMatchModel(
                                        contest.getInt("id"),
                            ...
                            CompleteMatchAdapter adapter = new CompleteMatchAdapter(CompleteMatches.this, productList);
