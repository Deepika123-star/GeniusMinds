...
public class LivebatingMatchAdapter  extends RecyclerView.Adapter<LivebatingMatchAdapter.ProductViewHolder>{


    private Context mCtx;
    private List<LivebatingMatchModel> productList;

    //    String path="https://geniusbetting.in/admin/upload/";

    public LivebatingMatchAdapter(Context mCtx, List<LivebatingMatchModel> productList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(final ProductViewHolder holder, int position) {
        final LivebatingMatchModel product = productList.get(position);
...
//                mCtx.startActivity(intent);
                ...
                Intent intent = new Intent(mCtx, LiveBatingContestActivity.class);
