...
import static com.genius.minds.Config.MyBaseUrl.LIVE_CONTEST;
import static com.genius.minds.Config.MyBaseUrl.LIVE_MATCH_SCORE;

public class LiveContest extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener  {

    List<LiveContestModel> productList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnscorecard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(LiveContest.this, ScorecardImage.class);
    ...
    private void loadCategory() {
        ...
        Log.d("Finalurl",LIVE_CONTEST+emailuser+"&category="+category+"&subcat="+subcat);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, LIVE_CONTEST+emailuser+"&category="+category+"&subcat="+subcat+"&series="+series+"&matchcode="+matchcode,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new LiveContestModel(
                                        contest.getInt("id"),
                            ...
                            LiveContestAdapter adapter = new LiveContestAdapter(LiveContest.this, productList);
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Live Match Contest");
    }
