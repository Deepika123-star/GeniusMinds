...
public class NewAdapterLiveCategory extends RecyclerView.Adapter<NewAdapterLiveCategory.AdapterViewHolder> {
   List<SubcategoryListItem> model_banners;
   Context context;

   public NewAdapterLiveCategory(List<SubcategoryListItem> model_banners, Context context) {
