...
public class AdapterHomeLive extends RecyclerView.Adapter<AdapterHomeLive.AdapterViewHolder> {
    List<CategoryListItem> model_banners;
    Context context;

    public AdapterHomeLive(List<CategoryListItem> model_banners, Context context) {
...
//                Intent intent=new Intent(context, NewLiveMatchActivity.class);
...
//                context.startActivity(intent);
                ...
                Intent intent=new Intent(context, LiveAllCatgoryActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_MULTIPLE_TASK);
                intent.putExtra("category",model_banners.get(position).getName());
                context.startActivity(intent);
            }
