...
public class NewLiveMatchAdapter extends RecyclerView.Adapter<NewLiveMatchAdapter.AdapterViewHolder> {
   List<MatchListItem> model_banners;
   Context context;

   public NewLiveMatchAdapter(List<MatchListItem> model_banners, Context context) {
