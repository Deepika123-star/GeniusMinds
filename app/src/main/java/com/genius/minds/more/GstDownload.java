...
public class GstDownload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gst_download);
...
//        String url="https://geniusbetting.in/gst.pdf";
        String url="https://pragatisoulutions.com/geniusbetting/Certificate.pdf";
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Gst Certificate");
    }
