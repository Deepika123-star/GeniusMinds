...
import com.genius.minds.Fragment.NumberFragment;
...
//                .show();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //sharedPrefManager.initializeInstance(getActivity());
    ...
    public void goToActivity(NumberFragment numberFragment, Class<?> classActivity, Bundle bundle) {
    ...
    public void goToActivityWithFinish(HomeFragment homeFragment, Class<?> classActivity, Bundle bundle) {
        Intent intent = new Intent(getContext(), classActivity);
        if (bundle != null)
            intent.putExtra(PAYLOAD_BUNDLE, bundle);
        Util.hideSoftKeyboard(getActivity());
    ...
    public void requestSMSPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.SEND_SMS)
            ...
            Util.createSimpleDialog1(getActivity(), getString(R.string.alert_text), getString(R.string.permission_camera_rationale11), getString(R.string.reqst_permission), () -> ActivityCompat.requestPermissions(getActivity(), new String[]{
